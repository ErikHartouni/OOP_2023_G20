...
public enum InputType {
    USER_CREATION(  "^ADD\\s+USER\\s+[!-z]+\\s+[!-z]+$" ),
    ADMIN_CREATION(  "^ADD\\s+ADMIN\\s+[!-z]+\\s+[!-z]+$" ),
    ...
    CHOSE_MY_RESTAURANT(  "^SHOW\\s+MY\\s+RESTAURANTS$" ),
    SHOW_MY_FOODS(  "^SHOW\\s+MY\\s+FOODS$" ),
    CHOSE_MY_FOOD(  "^CHOSE\\s+MY\\s+RESTAURANT\\s+[!-z]+$" ),
    ...
    DELETE_FOOD(  "^DELETE\\s+FOOD\\s+[A-z0-9]$" ),
    DEACTIVATE_FOOD(  "^DEACTIVATE\\s+FOOD\\s+[A-z0-9]+$" ),
    ACTIVATE_FOOD(  "^ACTIVATE\\s+FOOD\\s+[A-z0-9]+$" ),
